...
if("TRUE" STREQUAL "TRUE")
  set(abb_irb5400_support_SOURCE_PREFIX /home/ticonipa/curso_ros/Clase 5/ROS_Specialization/Tarea 4/ws_work_4/src/abb_irb5400_support)
  set(abb_irb5400_support_DEVEL_PREFIX /home/ticonipa/curso_ros/Clase 5/ROS_Specialization/Tarea 4/ws_work_4/devel)
  ...
  set(abb_irb5400_support_INSTALL_PREFIX /home/ticonipa/curso_ros/Clase 5/ROS_Specialization/Tarea 4/ws_work_4/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'abb_irb5400_support' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ticonipa/curso_ros/Clase 5/ROS_Specialization/Tarea 4/ws_work_4/src/abb_irb5400_support/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ticonipa/curso_ros/Clase 5/ROS_Specialization/Tarea 4/ws_work_4/devel/lib;/opt/ros/noetic/lib)
